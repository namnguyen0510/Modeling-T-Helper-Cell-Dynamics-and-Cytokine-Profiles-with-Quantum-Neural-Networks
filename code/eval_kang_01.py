...
data = pd.read_csv('clinical_datasets/1. kang_HIV-HCV/kang_01.csv')
data = data[data['Group'] == group_name]
y_true = data.iloc[:,2].to_numpy().astype('float')
y_true = MinMaxNormalization(y_true)
print(data)

ratio_df = pd.read_csv('clinical_datasets/1. kang_HIV-HCV/kang_02.csv')
...
for epoch in range(epochs):
    ...
    if loss < best_loss:
        ...
        best_Th1 = dynamics[0]/10
        best_Th2 = dynamics[1]/10
